	...
	public static SessionFactory getSessionFactory()
	{
		try {
			if(sf==null)
			{
				...
				map.put(Environment.JAKARTA_JDBC_URL, "jdbc:mysql://localhost:3306/hibernate1");
				...
				map.put(Environment.USE_QUERY_CACHE, "true"); 
				...
				mds.addAnnotatedClass(Transaction1.class);
